...
export default function PlayersPage() {
  ...
  const groupPlayersByPosition = (players: Player[]): PlayerGroup[] => {
    ...
    players.forEach(player => {
      ...
      if (position.includes('vartininkas') || position.includes('goalkeeper')) {
        positionGroups['Vartininkai'].push(player)
      } else if (position.includes('saugas') || position.includes('defender') || position.includes('gynėjas')) {
      ...
      } else if (position.includes('puolėjas') || position.includes('forward') || position.includes('striker')) {
