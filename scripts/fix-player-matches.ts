...
async function main() {
    console.log("Fixing incorrect player matches...");

    // Manual corrections for incorrect matches
    const corrections = [
        {
            playerName: "Mantas Bertašius",
            correctImage: "Mantas Bertasius 55 vartininkas.png",
        },
        {
            playerName: "Matas Ambrazaitis",
            correctImage: "Matas-Ambrazaitis.png",
        },
        {
            playerName: "Natanas Žebrauskas",
            correctImage: "Natanas Zebraskas 1.png",
        },
        {
            playerName: "Vaidas Magdušauskas",
            correctImage: "Vaidas Magusauskas 1.png",
        },
    ];
