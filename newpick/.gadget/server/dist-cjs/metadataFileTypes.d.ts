...
type GadgetSettings = {
	...
	frameworkVersion: "v0.1" | "v0.2" | "v0.3" | "v0.3.1" | "v1.0.0" | "v1.1.0" | "v1.2.0" | "v1.3.0" | "v1.4.0" | "v1.5.0"
	plugins: {
		connections?: {
			shopify?: ({
				apiVersion: "2022-01" | "2022-04" | "2022-07" | "2022-10" | "2023-01" | "2023-04" | "2023-07" | "2023-10" | "2024-01" | "2024-04" | "2024-07" | "2024-10" | "2025-01" | "2025-04" | "2025-07"
...
type GadgetModel = {
	...
	storageKey: string
	/** A comment describing this model to other developers */
